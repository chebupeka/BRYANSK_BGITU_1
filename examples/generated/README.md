...
- тема, которую черновик задаёт явно (`subject` в `in_draft`), дословно сохранена в 22 файлах
  из 24;
...
Кроме того, каждый документ прочитан рядом со своим черновиком. Без замечаний по содержанию
19 файлов из 24. В пяти остальных текст расходится с черновиком не только стилем:

- `information_note_02_colloquial.docx` — **противоречие черновику.** В черновике «отдел
  развития сделал много», «план выполнен на 92 процента», «остальное доделаем до 31.03.2025».
  Документ начинается фразой «Отдел развития завершил выполнение мероприятий за первый квартал
  2025 года», а ниже сохраняет «план выполнен на 92 процента».
- `service_memo_02_colloquial.docx` — **добавлены сведения, которых нет в черновике.**
  «Поставщик ТехноСнаб обещал привезти за 10 дней» стало «Поставщик ООО "ТехноСнаб"
  гарантирует поставку оборудования в течение 10 дней»: организационно-правовая форма «ООО»
  дописана, «обещал» усилено до «гарантирует», кавычки прямые, а не «ёлочки». «Нам надо купить»
  смягчено до «Прошу рассмотреть возможность приобретения». Тема «О закупке офисной техники»,
  заданная в черновике, заменена на «О закупке компьютеров для отдела аналитики».
- `letter_02_colloquial.docx` — тема «О сотрудничестве в сфере поставок», заданная в черновике,
  заменена на «О заключении договора на поставку мебели».
- `edge_03_mixed_alphabets.docx` — просьба «подтвердить поставку» стала просьбой «подтвердить
  возможность поставки».
- `edge_04_number_formats.docx` — даты «31.03.2025» и «15.03.2025» переписаны как
...
Эти файлы оставлены в примерах как есть: они показывают, почему текст после обработки нужно
сверить с черновиком перед отправкой.
...
| [information_note_02_colloquial](../drafts/information_note_02_colloquial.txt) | [information_note_02_colloquial.docx](information_note_02_colloquial.docx) | Информационная справка | classic | Убраны «Вообщем», «сделал много», «это нормально», «доделаем»; «утвердили» → «был утверждён». Все числа и даты на месте. **Замечание:** первая фраза «Отдел развития завершил выполнение мероприятий за первый квартал 2025 года» противоречит черновику, где план выполнен на 92 процента (см. «Что проверено») |
...
| [edge_03_mixed_alphabets](../drafts/edge_03_mixed_alphabets.txt) | [edge_03_mixed_alphabets.docx](edge_03_mixed_alphabets.docx) | Письмо | classic | Латиница оставлена как есть: «CEO» в адресате, «Equipment delivery» в теме, «120 000 RUB». Организация не выделена из строки адресата — метка в колонтитуле; дата и номер — метки. **Замечание:** «подтвердить поставку» → «подтвердить возможность поставки» |
